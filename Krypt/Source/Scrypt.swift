...
final class Scrypt {
  private final var salsaBuffer: [UInt32] = [UInt32](repeating: 0, count: 16)
  private final var salsaOutput: [UInt32] = [UInt32](repeating: 0, count: 16)
...
func arrayUtil_convertArray<S, T>(_ source: [S], to _: T.Type) -> [T] {
